package com.alpha.archive.feature.home.recommend.detail.view.ui
...
import com.alpha.archive.core.ui.components.RecommendDetailScreenLayout
import com.alpha.archive.core.ui.components.RecommendDetailScreenState
import com.alpha.archive.feature.home.recommend.detail.view.RecommendDetailViewModel
...
fun RecommendDetailScreen(
    ...
    val recommendState = RecommendDetailScreenState(
        ...
        data = uiState.data?.let { data ->
            com.alpha.archive.core.ui.components.RecommendDetailScreenData(
                title = data.title,
